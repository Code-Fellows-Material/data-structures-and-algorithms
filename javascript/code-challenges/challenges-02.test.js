...
const raisedToTheThird = (arr) => {
  let newArray = arr.map(val => val**3);
  return newArray;
};
...
const mapTwoToThe = (arr) => {
  let newArray = arr.map(val => 2**val);
  return newArray;
};
...
const charCode = (arr) => {
  let newArray = arr.map(val => val.charCodeAt());
  return newArray;
};
...
const extractAbilities = (arr) => {
  let newArray = arr.map(val => val.ability.name);
  return newArray;
};
...
const extractStats = (arr) => {
  let newArray = arr.map(val => {
    const totalStats = val.effort + val.baseStat;

...
// console.log("pre", testTree.preOrder_DFS());
// console.log("##################");
// console.log("in", testTree.inOrder_DFS());
// console.log("##################");
// console.log("post", testTree.postOrder_DFS());
// console.log("##################");
// console.log(testTree.contains(13));
// console.log("##################");
// console.log(testTree.add(14));
// console.log("##################");
// console.log("in", testTree.inOrder_DFS());
